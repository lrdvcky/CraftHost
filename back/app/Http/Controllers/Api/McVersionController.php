...
{
    /** GET /api/admin/pterodactyl-eggs — список доступных eggs из Pterodactyl */
    public function pterodactylEggs(PterodactylService $ptero)
    {
        return response()->json($ptero->listAllEggs());
    }
