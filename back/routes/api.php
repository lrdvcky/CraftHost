...
use App\Http\Controllers\Api\ServerModController;
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::prefix('servers')->group(function () {
        ...
        Route::get('/{id}/state',     [ServerController::class, 'state']);
        ...
        Route::post('/{id}/change-core',               [ServerController::class, 'changeCore']);
        Route::get('/{id}/cracked',                    [ServerController::class, 'getCracked']);
        Route::post('/{id}/cracked',                   [ServerController::class, 'setCracked']);
        Route::get('/{id}/backups/{backupId}/download',[BackupController::class, 'download']);

        Route::get('/{id}/mods',                       [ServerModController::class, 'index']);
        Route::post('/{id}/mods',                      [ServerModController::class, 'store']);
        Route::delete('/{id}/mods/{installId}',        [ServerModController::class, 'destroy']);
    });
    ...
    Route::middleware('admin')->prefix('admin')->group(function () {
        ...
        // Версии Minecraft
        Route::get('/pterodactyl-eggs',           [McVersionController::class, 'pterodactylEggs']);
        ...
        // Каталог модов/плагинов
        Route::get('/mods',                       [ModController::class, 'adminIndex']);
        Route::post('/mods',                      [ModController::class, 'store']);
        Route::put('/mods/{id}',                  [ModController::class, 'update']);
        Route::post('/mods/{id}',                 [ModController::class, 'update']); // multipart workaround
